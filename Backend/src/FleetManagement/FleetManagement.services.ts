...
export const createFleetManagementService = async (fleet: TIFleetManagement) => {
...
export const updateFleetManagementService = async (id: number, fleet: Partial<TIFleetManagement>) => {
