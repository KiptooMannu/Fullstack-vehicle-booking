...
export const createAuthService = async (auth: TIAuth): Promise<string> => {
...
export const updateAuthService = async (userId: number, auth: Partial<TIAuth>): Promise<string> => {
...
export const deleteAuthService = async (userId: number): Promise<string> => {
