...
export const store: EnhancedStore<{
  ...
  transactionsAPI: ReturnType<typeof transactionsAPI.reducer>;
  fleetManagementAPI: ReturnType<typeof fleetManagementAPI.reducer>;
  supportTicketAPI: ReturnType<typeof supportTicketAPI.reducer>;
  branchesAPI: ReturnType<typeof branchesAPI.reducer>;
  stripeAPI: ReturnType<typeof stripeAPI.reducer>;
}> = configureStore({
  reducer: rootReducer,
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware({
